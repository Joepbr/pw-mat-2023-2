...
function Tilt({children}) {
  ...
  //Quando o componente for carregado ("montado"), fazemos a associação entre a
  //biblioteca vanilla-tilt e a div identificada pela ref criada. O vetor de
  //dependências fica vazio exatamente para indicar que esse useeffect deve ser executado apenas na montagem do componente
  React.useEffect(() => {
   ...
   //Esta função retornada pelo useEffect() será executada quando o componente for descarregado da memória (fase "unmount")
   return () => {
