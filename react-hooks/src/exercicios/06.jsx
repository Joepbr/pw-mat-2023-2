...
function PokemonInfo({pokemonName}) {
  ...
  //Criando uma única variável de estado, do tipo objeto, com a mesma funcionalidade
  //das variáveis de estado avulsas comentadas acima
  ...
  async function requestPokemon() {
    ...
    try{
      ...
      //Solucitação resolvida com sucesso
      //setStatus('resolved')
  ...
  switch(status){
    case 'idle':  //Aguardando a ação do usuário
      return 'Informe um pokemon'

    case 'pending': //Aguardando a resolução de rquisição
